    ...
    useEffect(() => {
        if (asset) {
            setFormData({
                ...
                purchase_date: asset.purchase_date ? asset.purchase_date.split('T')[0] : null,
                purchase_value: asset.purchase_value,
                entity_id: asset.entity_id,
                assigned_to: asset.assigned_to,
                location: asset.location || '',
                notes: asset.notes || '',
                warranty_expiration: asset.warranty_expiration ? asset.warranty_expiration.split('T')[0] : null,
